...
Wenn der Nutzer eine Schicht anlegen, ändern oder löschen möchte, erkläre, was er tun soll, oder frage nach fehlenden Details.`,
  ...
  return (
    <div className="p-4 sm:p-6 space-y-5">
      {/* §87: Ein Einstiegspunkt — hier steht, wo eingerichtet wird */}
      <div className="flex items-start gap-2 text-xs bg-brand/5 border border-brand/20 rounded-xl px-3 py-2.5">
        <span className="text-base leading-none">🚀</span>
        <span className="text-navy">
          <b>Eingerichtet wird unter <Link href="/admin/setup" className="text-brand hover:underline">Einstellungen → Einrichtung</Link>.</b>{' '}
          Dort legst du Betriebsform, Etagen &amp; Gruppen, Dienste, Team und Regeln fest — genau diese Daten verwendet die
          Dienstplanung. Diese Seite dient der Detailansicht, der Prüfung der Code-Regeln und dem Zurücksetzen.
        </span>
      </div>
